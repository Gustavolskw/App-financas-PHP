...
use App\Application\AMQPMessages\Account\CaixaUserInactivationExchangeConsumer;
...
try {
    ...
    $caixaConsumer = new CaixaUserInactivationExchangeConsumer($repository, $logger, $connection);

    echo "Consumidor criado, iniciando consumo de exchnage de inativação...\n";
    $caixaConsumer->handleExchange(getenv("RABBITMQ_FAN_OUT_EXCHANGE_INACT"),'acc.user.inactivated' );
